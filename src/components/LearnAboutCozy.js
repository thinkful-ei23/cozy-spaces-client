    ...
    return (
        <main role="main">
          ...
          <ul>    
            ...
            <li>Calm Environment: Babies, children, and loud people are not conducive to a calm environment. A bustling coffee shop full of office workers going to and for is also not a calm environment. A cozy space should feel somewhat separate from the concerns of daily life. It should be lively but not busy.</li>
